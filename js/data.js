...
// ---------- Glossary: English term <-> Russian translation ----------
const TERMS = [
  { en: "ADSL", ru: "асимметричная цифровая абонентская линия", unit: 1 },
  { en: "backbone", ru: "магистраль", unit: 1 },
  { en: "bandwidth", ru: "пропускная способность", unit: 1 },
  { en: "broadband access", ru: "широкополосный доступ", unit: 1 },
  { en: "cellular connection", ru: "сотовая связь", unit: 1 },
  { en: "coaxial cable", ru: "коаксиальный кабель", unit: 1 },
  { en: "copper twisted-pair cable", ru: "медный кабель витой пары", unit: 1 },
  { en: "dedicated line", ru: "выделенная линия", unit: 1 },
  { en: "dial-up access", ru: "коммутируемый доступ", unit: 1 },
  { en: "distortion of a signal", ru: "искажение сигнала", unit: 1 },
  { en: "DSL", ru: "цифровая абонентская линия", unit: 1 },
  { en: "fiber-optic cable", ru: "оптоволоконный кабель", unit: 1 },
  { en: "frequency", ru: "частота", unit: 1 },
  { en: "satellite connection", ru: "спутниковое соединение", unit: 1 },
  { en: "SDSL", ru: "симметричная цифровая абонентская линия", unit: 1 },
  { en: "transceiver", ru: "приёмо-передатчик", unit: 1 },
  { en: "crawler", ru: "поисковый робот", unit: 2 },
  { en: "hyperlink", ru: "гиперссылка", unit: 2 },
  { en: "indexing", ru: "индексация", unit: 2 },
  { en: "keywords", ru: "ключевые слова", unit: 2 },
  { en: "ranking", ru: "ранжирование", unit: 2 },
  { en: "relevant result", ru: "релевантный результат", unit: 2 },
  { en: "request", ru: "запрос", unit: 2 },
  { en: "search bar", ru: "поисковая строка", unit: 2 },
  { en: "search engine", ru: "поисковая система", unit: 2 },
  { en: "tab", ru: "вкладка", unit: 2 },
  { en: "URL", ru: "электронный адрес ресурса", unit: 2 },
  { en: "web browser", ru: "веб-браузер", unit: 2 },
  { en: "assembler", ru: "ассемблер", unit: 3 },
  { en: "binary code", ru: "двоичный код", unit: 3 },
  { en: "compatible", ru: "совместимый", unit: 3 },
  { en: "compiler", ru: "компилятор", unit: 3 },
  { en: "debugging", ru: "отладка", unit: 3 },
  { en: "encapsulation", ru: "инкапсуляция", unit: 3 },
  { en: "high-level language", ru: "язык высокого уровня", unit: 3 },
  { en: "inheritance", ru: "наследование", unit: 3 },
  { en: "interpreter", ru: "интерпретатор", unit: 3 },
  { en: "low-level language", ru: "язык низкого уровня", unit: 3 },
  { en: "machine code", ru: "машинный код", unit: 3 },
  { en: "OOP", ru: "объектно-ориентированное программирование", unit: 3 },
  { en: "polymorphism", ru: "полиморфизм", unit: 3 },
  { en: "source code", ru: "исходный код", unit: 3 },
  { en: "backend development", ru: "бэкенд-разработка", unit: 4 },
  { en: "CSS", ru: "каскадные таблицы стилей", unit: 4 },
  { en: "frontend development", ru: "фронтенд-разработка", unit: 4 },
  { en: "HTML", ru: "язык гипертекстовой разметки", unit: 4 },
  { en: "JavaScript", ru: "джаваскрипт", unit: 4 },
  { en: "layout", ru: "макет", unit: 4 },
  { en: "markup tags", ru: "теги разметки", unit: 4 },
  { en: "to rank high", ru: "высоко ранжироваться", unit: 4 },
  { en: "SEO", ru: "поисковая оптимизация", unit: 4 },
  { en: "template", ru: "шаблон", unit: 4 },
  { en: "website builder", ru: "конструктор сайтов", unit: 4 },
  { en: "WYSIWYG", ru: "что видишь, то и получишь", unit: 4 },
  { en: "adware", ru: "рекламное ПО", unit: 5 },
  { en: "copyright violation", ru: "нарушение авторских прав", unit: 5 },
  { en: "cybercrime", ru: "киберпреступность", unit: 5 },
  { en: "DDoS attack", ru: "DDoS-атака", unit: 5 },
  { en: "defacement", ru: "дефейс", unit: 5 },
  { en: "keylogger", ru: "кейлоггер", unit: 5 },
  { en: "malware", ru: "вредоносное ПО", unit: 5 },
  { en: "miner", ru: "майнер", unit: 5 },
  { en: "misdirection routine", ru: "процедура дезориентации", unit: 5 },
  { en: "payload", ru: "вредоносная нагрузка", unit: 5 },
  { en: "phishing", ru: "фишинг", unit: 5 },
  { en: "piggybacking", ru: "пиггибэкинг", unit: 5 },
  { en: "ransomware", ru: "программа-вымогатель", unit: 5 },
  { en: "reproduction routine", ru: "процедура размножения", unit: 5 },
  { en: "salami shaving", ru: "тактика салями", unit: 5 },
  { en: "software piracy", ru: "компьютерное пиратство", unit: 5 },
  { en: "spyware", ru: "шпионское ПО", unit: 5 },
  { en: "trigger", ru: "триггер", unit: 5 },
  { en: "Trojan", ru: "троян", unit: 5 },
  { en: "virus", ru: "вирус", unit: 5 },
  { en: "worm", ru: "червь", unit: 5 },
  { en: "backup", ru: "резервное копирование", unit: 6 },
  { en: "biometric authentication", ru: "биометрическая аутентификация", unit: 6 },
  { en: "brute force", ru: "полный перебор", unit: 6 },
  { en: "CAPTCHA", ru: "капча", unit: 6 },
  { en: "cryptanalysis", ru: "криптоанализ", unit: 6 },
  { en: "cybersecurity", ru: "кибербезопасность", unit: 6 },
  { en: "to deny access", ru: "отказать в доступе", unit: 6 },
  { en: "encryption", ru: "шифрование", unit: 6 },
  { en: "firewall", ru: "сетевой экран", unit: 6 },
  { en: "MFA", ru: "многофакторная аутентификация", unit: 6 },
  { en: "to update antivirus software", ru: "обновлять антивирусное ПО", unit: 6 },
  { en: "Artificial Intelligence", ru: "искусственный интеллект", unit: 7 },
  { en: "artificial neural network", ru: "искусственная нейронная сеть", unit: 7 },
  { en: "augmented reality", ru: "дополненная реальность", unit: 7 },
  { en: "backpropagation", ru: "обратное распространение ошибки", unit: 7 },
  { en: "biometrics", ru: "биометрия", unit: 7 },
  { en: "Internet of Things", ru: "интернет вещей", unit: 7 },
  { en: "machine learning", ru: "машинное обучение", unit: 7 },
  { en: "raw data", ru: "необработанные данные", unit: 7 },
  { en: "smart home", ru: "умный дом", unit: 7 },
  { en: "virtual reality", ru: "виртуальная реальность", unit: 7 },
  { en: "backend developer", ru: "бэкенд-разработчик", unit: 8 },
  { en: "cloud architect", ru: "облачный архитектор", unit: 8 },
  { en: "data scientist", ru: "специалист по данным", unit: 8 },
  { en: "database administrator", ru: "администратор баз данных", unit: 8 },
  { en: "frontend developer", ru: "фронтенд-разработчик", unit: 8 },
  { en: "full-stack developer", ru: "фулстек-разработчик", unit: 8 },
  { en: "network engineer", ru: "сетевой инженер", unit: 8 },
  { en: "pen tester", ru: "пентестер", unit: 8 },
  { en: "software engineer", ru: "разработчик ПО", unit: 8 },
  { en: "security specialist", ru: "специалист по безопасности", unit: 8 },
  { en: "system administrator", ru: "системный администратор", unit: 8 }
];

// ---------- Definition quiz: English definition -> term ----------
const DEFS = [
  { term: "DSL", def: "A broadband communication technology designed for use on telephone lines; it allows a single phone connection to be used for both Internet service and voice calls at the same time." },
  { term: "IP address", def: "A numerical label assigned to every device in a network that uses the Internet." },
  { term: "fiber-optic technology", def: "The fastest wired way to access the Internet, transmitting information as pulses of light through strands of fiber over long distances." },
  { term: "WWW", def: "A network of documents that works in a hypertext environment, using text that contains links to other documents." },
  { term: "cable Internet", def: "A high-speed broadband access using a coaxial cable to transmit data." },
  { term: "bandwidth", def: "The quantity of data that can be transmitted through a network, measured in bits per second." },
  { term: "dial-up connection", def: "The least expensive but slowest way to access the Internet, which uses a standard phone line and analog modem." },
  { term: "cellular network", def: "A radio network distributed over land areas called cells, each served by a fixed-location transceiver known as a cell tower." },
  { term: "satellite connection", def: "An Internet access technology considered an alternative to terrestrial communications." },
  { term: "packet switching", def: "A technology allowing huge files to be broken down into smaller chunks, ensuring reliable and efficient data transmission." },
  { term: "Wi-Fi", def: "A high-speed Internet connection operating over LAN without cables, whose essential elements are radio signals and a wireless router." },
  { term: "crawler", def: "A special program also known as a spider that finds new and updated content." },
  { term: "indexing", def: "The process of associating content of a site with certain keywords." },
  { term: "search engine", def: "A program that allows users to extract requested information from the huge database of resources available on the Internet." },
  { term: "URL", def: "The address of a file on the Internet." },
  { term: "query", def: "A request that a user enters into a search box." },
  { term: "browser", def: "A computer program with a graphical user interface for displaying and navigating between web pages." },
  { term: "search bar", def: "A field on the screen that accepts typed-in text in order to look up something or launch a search." },
  { term: "ranking", def: "Ordering results from most relevant to least relevant." },
  { term: "hyperlink", def: "A highlighted word or image in a hypertext document that takes a user to another location when clicked." },
  { term: "assembler", def: "A special program that converts a program written in a low-level language into machine code." },
  { term: "binary code", def: "A code made of just two numbers (0 and 1)." },
  { term: "assembly language", def: "A low-level language that uses abbreviations such as ADD, SUB, and MUL to represent instructions." },
  ...
  { term: "object-oriented language", def: "A high-level language allowing to alter a particular function of a program without changing the entire program." },
  { term: "interpreter", def: "A special program that translates the source code line by line, as the program is running." },
  { term: "encapsulation", def: "The ability to bind data and methods into one unit." },
  { term: "source code", def: "Program instructions written in a particular computer language." },
  { term: "debugging", def: "The techniques of detecting and correcting errors which may occur in programs." },
  { term: "compatible", def: "Capable of running on most computer platforms." },
  { term: "CSS", def: "A mechanism for adding style (e.g. fonts, colors, spacing) to web documents." },
  { term: "home page", def: "The first page on a website that usually contains links to other pages." },
  { term: "HTML", def: "The language used to create hypertext documents (e.g. web pages)." },
  { term: "frontend development", def: "A field of web development that focuses on the visible part of the site." },
  { term: "SEO", def: "A set of improvements that help your website to rank higher in Search Engine Results Page." },
  { term: "layout", def: "The arrangement of content on a web page, including text, images, videos, and other elements." },
  { term: "backend development", def: "A field of web development associated with the part of the site connected to the server." },
  { term: "website builder", def: "A platform that can be used to create a website without having to code." },
  { term: "template", def: "A pattern used as a guide to design a web page." },
  { term: "markup tags", def: "Instructions used in markup languages." },
  { term: "customize", def: "To modify a template of a web page to your needs." },
  { term: "spyware", def: "Malicious software designed to enter a device, gather data about a person or organization, and forward it to a third party without consent." },
  { term: "adware", def: "A form of financially supported malware that usually presents itself as unwanted commercials." },
  { term: "keylogger", def: "A type of spyware used to monitor and record each keystroke on a specific keyboard, often used for stealing passwords." },
  { term: "worm", def: "A standalone malicious program that replicates itself to infect other computers, spreading across the network without attaching itself to an existing program." },
  { term: "hijacking", def: "A type of cybercrime which involves redirecting anyone trying to visit a certain site elsewhere." },
  { term: "DDoS attack", def: "An attack where hackers overload networks and servers with traffic so that computer systems cannot keep up with legitimate needs." },
  { term: "Trojan horse", def: "Malware that misleads users of its true intent by pretending to be a useful program." },
  ...
  { term: "piggybacking", def: "Using technology to open the Internet connection to unwanted users." },
  { term: "ransomware", def: "A type of malware that threatens to publish the victim's data or blocks access to the device unless a payment is made." },
  { term: "miner", def: "A virus which uses your computer power to earn cryptocurrency for others." },
  { term: "software piracy", def: "Unauthorized copying of a program for sale or distributing to other users." },
  ...
  { term: "salami shaving", def: "A computer crime in which a program is altered to transfer a small amount of money from a large number of accounts." },
  ...
  { term: "cybersecurity", def: "The practice employed to protect computers, servers, networks, mobile devices, electronic systems, and data from being attacked." },
  { term: "multi-factor authentication", def: "A user verification technology that requires more than one type of user validation." },
  { term: "encryption", def: "A way of encoding data so that only authorized parties can understand the information." },
  { term: "brute force", def: "Trying random keys aiming to decrypt encoded data." },
  { term: "password", def: "Secret data, typically a string of characters, usually used to confirm a user's identity." },
  { term: "cryptanalysis", def: "The method of spotting a weakness in the cipher aiming to decrypt encoded data." },
  { term: "CAPTCHA", def: "Completely Automated Public Turing test to tell Computers and Humans Apart." },
  { term: "artificial intelligence", def: "The ability of a computer or a robot controlled by a computer to do tasks that are usually done by humans." },
  { term: "IoT", def: "A system of interrelated computing devices, mechanical and digital machines provided with the ability to share data in order to automate processes." },
  { term: "virtual reality", def: "A computer-generated space in which the user interacts with artificial objects through 3-D computer simulation." },
  { term: "neural networks", def: "Computing systems with interconnected nodes that resemble neurons in the human brain, capable of recognizing patterns in raw data." },
  { term: "augmented reality", def: "An enhanced version of the real physical world, which integrates digital information with the existing environment in real time." },
  { term: "backpropagation", def: "An algorithm designed to test for errors working back from output nodes to input nodes." }
];
